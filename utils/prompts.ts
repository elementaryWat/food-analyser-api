...
3. Return a json with the keys proteins, carbohydrates, fats, serving_size, serving_size_g(in grams)  and calories.
`;
...
3. Return a json with the keys description, proteins, carbohydrates, fats, serving_size, serving_size_g(in grams)  and calories.`